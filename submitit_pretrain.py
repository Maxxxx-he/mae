...
def parse_args():
    ...
    parser.add_argument("--job_dir", default="/home/h_haoy/Documents/GitHub/mae", type=str, help="Job dir. Leave empty for automatic.")
...
def get_shared_folder() -> Path:
    user = os.getenv("USER")
    #print(user)
    if Path("/home/h_haoy/Documents/GitHub/mae/checkpoint/").is_dir():
        p = Path(f"/home/h_haoy/Documents/GitHub/mae/checkpoint/experiments")
        #print(p)
